...
public class MainActivity extends BaseActivity {
    ...
    public void initView() {
        StatusBarSetting.setColorForDrawerLayout(this, mAmDl, getColor(R.color.colorPrimary), StatusBarSetting.DEFAULT_STATUS_BAR_ALPHA);
        setToolBar();
        setNavigationView();
